...
class ChangeMyPasswordIntegrationTest extends BaseIntegrationTest {
        ...
        void testChangePasswordSuccess() throws Exception {
                ...
                ChangePasswordRequest request = buildRequest(USERNAME, EMAIL, CURRENT_PASSWORD, NEW_PASSWORD,
                                NEW_PASSWORD);
        ...
        void testWrongCurrentPassword() throws Exception {
                ...
                ChangePasswordRequest request = buildRequest(USERNAME, EMAIL, "WrongPassword!", NEW_PASSWORD,
                                NEW_PASSWORD);
        ...
        void testNewPasswordsMismatch() throws Exception {
                ...
                ChangePasswordRequest request = buildRequest(USERNAME, EMAIL, NEW_PASSWORD, "Nueva123!",
                                "Diferente123!");
        ...
        void testNewPasswordNoUpperCase() throws Exception {
                ...
                ChangePasswordRequest request = buildRequest(USERNAME, EMAIL, NEW_PASSWORD, "password123!",
                                "password123!");
