...
public enum ErrorCode {
    ...
    REGISTRATION_USERNAME_EXISTS("REG-001",
            "Encontramos un usuario registrado (Activo/Inactivo) con alguno de sus datos.", HttpStatus.CONFLICT),
    REGISTRATION_EMAIL_EXISTS("REG-002", "Encontramos un usuario registrado (Activo/Inactivo) con alguno de sus datos.",
            HttpStatus.CONFLICT),
    ...
    RECOVERY_MAX_ATTEMPTS_EXCEEDED("REC-001",
            "Máximo de intentos de recuperación excedido. Servicio bloqueado por 24 horas", HttpStatus.LOCKED),
