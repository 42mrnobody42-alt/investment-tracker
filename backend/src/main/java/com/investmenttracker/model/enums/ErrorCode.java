...
public enum ErrorCode {
        ...
        // Errores de registro
        REGISTRATION_USERNAME_EXISTS("REG-001",
                        "Encontramos un usuario registrado (Activo/Inactivo) con alguno de sus datos.",
                        HttpStatus.CONFLICT),
        REGISTRATION_EMAIL_EXISTS("REG-002",
                        "Encontramos un usuario registrado (Activo/Inactivo) con alguno de sus datos.",
                        HttpStatus.CONFLICT),
        REGISTRATION_PAIS_CELULAR_EXISTS("REG-003",
                        "Encontramos un usuario registrado (Activo/Inactivo) con alguno de sus datos.",
                        HttpStatus.CONFLICT),
        REGISTRATION_TOKEN_EXPIRED("REG-004", "El token de confirmación ha expirado. Solicite un nuevo registro.",
                        HttpStatus.BAD_REQUEST),
        REGISTRATION_TOKEN_INVALID("REG-005", "Token de confirmación inválido.", HttpStatus.BAD_REQUEST),
        REGISTRATION_CONFIRM_MISMATCH("REG-006", "Los datos de confirmación no coinciden con la solicitud inicial.",
                        HttpStatus.BAD_REQUEST),
        PAIS_NOT_FOUND("REG-007", "El país seleccionado no existe.", HttpStatus.NOT_FOUND),
        REGISTRATION_PASSWORD_DOES_NOT_MATCH("REG-008", "Las contraseñas no coinciden.", HttpStatus.BAD_REQUEST),
        ...
        RECOVERY_MAX_ATTEMPTS_EXCEEDED("REC-001",
                        "Máximo de intentos de recuperación excedido. Servicio bloqueado por 24 horas",
                        HttpStatus.LOCKED),
        RECOVERY_TOKEN_EXPIRED("REC-002", "El token de recuperación ha expirado. Solicite uno nuevo",
                        HttpStatus.BAD_REQUEST),
        RECOVERY_TOKEN_INVALID("REC-003", "Token inválido. Verifique e intente nuevamente", HttpStatus.BAD_REQUEST),
        RECOVERY_USER_MISMATCH("REC-004", "Los datos del usuario no coinciden con los registrados",
                        HttpStatus.NOT_FOUND),
        RECOVERY_EMAIL_SEND_ERROR("REC-005", "Error al enviar el correo de recuperación. Intente más tarde",
        ...
        // Errores internos
        RATE_LIMIT_EXCEEDED("RATE-001", "Demasiadas peticiones. Intente nuevamente más tarde",
        ...
        INVALID_ARGUMENTS("SYS-03", "Argumentos invalidos", HttpStatus.INTERNAL_SERVER_ERROR);
