...
# Condiciones de desarrollo para la IA:

Cada comando ejecutado tiene que tener path absoluto sin usar variables de entorno: /prog/datos/investment-tracker

El archivo README.md contiene la información CRITICA y de forma general del avance en el proyecto al ultimo día.

El codigo recomendado debe siempre ajustarse al codigo implementado, si no tiene contexto del archivo, función, documento, script usado o referenciado, debe solicitarlo concer el codigo exato y entregar una respuesta con base en el codigo de la aplicación.

El codigo de backend debe ser arquitectura hexagonal y las mejores practicas de la industria, funciones minimas de unico proceso, crear pruebas unitarias y el codigo debe ser limpio de errores y warnings de desarrollo y pruebas.
