...
BEGIN
    IF EXISTS (
        ...
        WHERE version = '00_001_000' AND script_name = '40_tablas/00_001_000_05_cr_usuario_roles.sql'
    ) THEN
...
VALUES ('00_001_000', 'Tabla usuario_roles', '40_tablas/00_001_000_05_cr_usuario_roles.sql')
